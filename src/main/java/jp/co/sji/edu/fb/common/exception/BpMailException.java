 ...
 * @author Edu.SJI
 */
public class BpMailException extends RuntimeException {
     ...
     * @param message エラーメッセージ
     */
    public BpMailException(final String message) {
        super(message, null);
        setMessage(message);
    }
     ...
     * @param param パラメータ
     */
    public BpMailException(final String message, Object... param) {
        super(message, null);
        setMessage(message);
     ...
     * @param throwable エラー
     */
    public BpMailException(final Throwable throwable) {
        super(throwable);
    }
     ...
     * @param throwable エラー
     */
    public BpMailException(final String message, final Throwable throwable) {
